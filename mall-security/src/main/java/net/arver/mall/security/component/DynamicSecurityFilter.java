...
import net.arver.mall.security.config.IgnoreUrlsConfig;
...
public class DynamicSecurityFilter extends AbstractSecurityInterceptor implements Filter {
    ...
    @Autowired
    public void setMyAccessDecisionManager(final DynamicAccessDecisionManager dynamicAccessDecisionManager) {
